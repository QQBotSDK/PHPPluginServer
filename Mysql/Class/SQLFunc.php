...
class GetSqlFunc
{
            ...
            if ($mode == 'value') {
                ...
                if ($mode == 'clause') {
                    ...
                    if ($mode == 'bind') {
                        ...
                        if ($mode == 'listrow') {
                            $this->FuncEssential['listrow'] = $data;
                        }else {
                            if ($mode == 'by') {
                                $this->FuncEssential['by'] = $data;
                            }else {
                                if ($mode == 'order') {
                                    $this->FuncEssential['order'] = $data;
                                }else {
                                    if ($mode == 'page') {
                                        $this->FuncEssential['page'] = $data;
                                    }
                                }
                            }
                        }
    ...
    {
        return $this->EssentialPushing('by', $data);
    }
    ...
    {
        return $this->EssentialPushing('order', $data);
    }
    public function listrow($data)
    {
        //return false;
        return $this->EssentialPushing('listrow', $data);
    }
    public function page($data)
    {
        //return false;
        return $this->EssentialPushing('page', $data);
    }
